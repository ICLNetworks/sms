                                    ...
                                    <tbody>
									   ...
									   <?php
										...
										$shift=$_POST['shift'];
											...
											$result = mysqli_query($conn,"SELECT * FROM register1 where course='$course' && shift='$shift' && batch='$batch'");
											  ...
											  <a  class='btn btn-success' href='tcissuedview.php?id=$id'>".$row['status']."</a>
