                                    ...
                                    <tbody>
									   ...
									   <?php
										...
										$shift=$_POST['shift'];
											...
											$result = mysql_query("SELECT * FROM register where course='$course' && shift='$shift' && batch='$batch' && status='Not Issued'");
											  ...
											  echo "<td>".$row['adno']."</td>";
											  echo "<td>".$row['doa']."</td>";
											  echo "<td>".$row['course']."/".$row['shift']."</td>";
											  echo "<td>".$row['name']."</td>";
											  ...
											  <a  href='admission1.php?id=$id'><i class='icon-edit'></i></a>
											  
											  </td>";
											  echo "<td class='center' width='10px'>
											  
											  
											  <button   onClick='delete1($id);'><i class='icon-remove'></i></button>
