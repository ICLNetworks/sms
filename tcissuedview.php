		...
		<div class="row">
				...
				<center><h5><b>Application form for admission to B.Sc.,/B.A.,/B.Com., courses under Choice Based Credit System(CBCS)</b> </h5></center>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <tbody>
										...
										<tr>
                                            ...
                                            <td><div class="form-group">
                                            <div class="col-lg-8">
											<label class="control-label"><?php $mark=$row['mark'];
					...
					<?php
						...
						{
					echo "<center><a href='issuethetc.php?id=$id' class='btn btn-info btn-lg btn-grad'>Issue</a>
						<a href='adminview.php' class='btn btn-info btn-lg btn-grad'>Back</a></center>";		
						}
						else
						{
						
						echo "<center><a href='tc.php?id=$id' class='btn btn-info btn-lg btn-grad'>View TC</a>
						<a href='adminview.php' class='btn btn-info btn-lg btn-grad'>Back</a></center>";		
