...
<body >
	...
	<div id="main"> 
      ...
      <div class="container">
		...
		<form  id="block-validate" action="changedeleteall.php" name="form1" method="post" onSubmit="return check();">
		<div class="row">
		
                <div class="col-lg-12">
				<center><h3><b>Transfer Certificate Edit/Delete</b> </h3></center>
				</center>
